...
def Bayesian_optimization_Simulation_scenario(num_vars, bounds, initial_points,
                                              y_initial_points, defaults, whether_to_optimize, r,
                                              max_iteration, time_start, repetition):
    ...
    for i in range(max_iteration):
        ...
        y_new = Running.objective_function(x_new, defaults, whether_to_optimize)
...
if __name__ == '__main__':
    ...
    for j in range(repetition):
        ...
        Pareto_front, Pareto_solution, All_PF, t = Bayesian_optimization_Simulation_scenario(num_vars, bounds, initial_points,
                                                  y_initial_points, defaults, whether_to_optimize, r,
                                                  max_iteration, time_start, repetition)
        ...
        np.save('.\\Results\\PF-MOBO5-Aircraft-repetition-' + str(j) + '.npy', Pareto_front)
        np.save('.\\Results\\PS-MOBO5-Aircraft-repetition-' + str(j) + '.npy', Pareto_solution)
        with open('.\\Results\\All_PF-MOBO5-Aircraft-repetition-' + str(j) + '.pkl', 'wb') as f:
            pickle.dump(All_PF, f)

        np.save('.\\Results\\RHD-MOBO5-Aircraft-repetition-' + str(j) + '.npy', rhd)
        np.save('.\\Results\\Time-MOBO5-Aircraft-repetition-' + str(j) + '.npy', np.array(t))
