...
bars = ax1.bar(x, PT, color=mcolors.to_rgba('#F4C950', alpha=0.35), edgecolor=mcolors.to_rgba('#F4C950'),
...
ax2.yaxis.label.set_color('#7A66B9')         # 轴标签文字
...
plt.tight_layout()
plt.savefig('Sensitivity Malaria.svg', dpi=800,
            bbox_inches='tight')
plt.show()
