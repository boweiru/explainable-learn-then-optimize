...
PF_TSO4 = []
for i in range(10):
    PF_TSO4.append(np.load('PF-NSGA100-WFG3-repetition-' + str(i) + '.npy'))
...
PS = []
for j in range(10):
    PS.append(np.load('PS-NSGA100-WFG3-repetition-' + str(j) + '.npy'))
...
plt.savefig('NSGA 100 PS WFG3.svg', dpi=800,
            bbox_inches='tight')
plt.show()
