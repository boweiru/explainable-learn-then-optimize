...
for j in range(10):
    ...
    np.save('.\\Results\\Time-NSGA5-Junction-repetition-' + str(j) + '.npy', time.time() - start_time)
    ...
    np.save('.\\Results\\PF-NSGA5-Junction-repetition-' + str(j) + '.npy', Pareto_front)
    np.save('.\\Results\\PS-NSGA5-Junction-repetition-' + str(j) + '.npy', Pareto_solution)

    np.save('.\\Results\\RHD-NSGA5-Junction-repetition-' + str(j) + '.npy', np.array(rhd))

    with open('.\\Results\\All_PF-NSGA5-Junction-repetition-' + str(j) + '.pkl', 'wb') as f:
