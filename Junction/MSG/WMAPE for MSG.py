...
sum_WMAPE_XGBoost_mean, sum_WMAPE_XGBoost_std = mean_std_per_dim(WMAPE_MSG)
sum_WMAPE_CatBoost_mean, sum_WMAPE_CatBoost_std = mean_std_per_dim(WMAPE_MSG_CatBoost)
sum_WMAPE_Model_mean, sum_WMAPE_Model_std = mean_std_per_dim(WMAPE_MSG_Model)
sum_WMAPE_Model_Data_mean, sum_WMAPE_Model_Data_std = mean_std_per_dim(WMAPE_MSG_Model_Data)
...
plt.tight_layout()
plt.savefig('MSG comparison Junction.svg', dpi=800,
            bbox_inches='tight')
plt.show()
