...
if __name__ == '__main__':
    ...
    for j in range(repetition):
        ...
        np.save('.\\Results\\PF-MOBO9-Corridor-repetition-' + str(j) + '.npy', Pareto_front)
        np.save('.\\Results\\PS-MOBO9-Corridor-repetition-' + str(j) + '.npy', Pareto_solution)
        with open('.\\Results\\All_PF-MOBO9-Corridor-repetition-' + str(j) + '.pkl', 'wb') as f:
            pickle.dump(All_PF, f)

        np.save('.\\Results\\RHD-MOBO9-Corridor-repetition-' + str(j) + '.npy', rhd)
        np.save('.\\Results\\Time-MOBO9-Corridor-repetition-' + str(j) + '.npy', np.array(t))
